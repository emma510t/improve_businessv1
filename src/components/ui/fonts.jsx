...
function H2({ children, className }) {
  return (
    <h2
      className={`font-bold text-[32px]/[1.4] pb-4 sm:text-4xl md:text-[38px]/[1.4] md:pb-7 lg:text-[46px]/[1.5] ${className}`}
    >
      {children}
    </h2>
  );
...
function P({ children, className }) {
  return (
    <p className={`text-base md:text-lg md:pb-[30px] lg:text-xl ${className}`}>
      {children}
    </p>
  );
}
