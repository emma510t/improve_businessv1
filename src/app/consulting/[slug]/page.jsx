    ...
    <>
      <SplitSection>
        <SplitSectionChild img>
          <Image src={`/img/${slugData.icon}.jpg`} alt={slugData.title} width={800} height={800} className="md:w-full md:h-full max-h-[340px] object-cover md:max-h-none bg-ibsilver-400" />
        </SplitSectionChild>
