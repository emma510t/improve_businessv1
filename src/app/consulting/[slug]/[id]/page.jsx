    ...
    <>
      <SplitSection>
        <SplitSectionChild img className="order-last">
          <Image className="md:w-full md:h-full max-h-[380px] object-cover md:max-h-none" src={`/img/ydelse/${idData.icon}.jpg`} alt={`${idData.title} billede`} width={800} height={800} />
        </SplitSectionChild>
        <SplitSectionChild>
          <div
            className="md:pb-7
