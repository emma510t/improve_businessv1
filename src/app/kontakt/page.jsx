    ...
    <>
      <SplitSection>
        <SplitSectionChild img className="order-last md:absolute md:right-0 md:left-1/2 md:bottom-0 md:top-0 md:w-[50vw]">
          <Image src="/img/contact-hero.webp" alt="Improve Business' kontorbygning" width={1920} height={1080} className="md:object-cover md:w-full md:h-full" />
        </SplitSectionChild>
        <SplitSectionChild>
          <PageTag>Kontakt</PageTag>
          <h1 className="font-bold text-ibsilver-600 text-[36px]">Tag kontakt</h1>
          <p className="mt-2 mb-4">Vi er klar til at hjælpe jer. Udfyld formularen og vi vender tilbage snarest!</p>
          <FormSetup />
        </SplitSectionChild>
      </SplitSection>
      <div class="bg-ibsilver-600 text-ibsilver-100 mt-8 w-screen relative left-1/2 right-1/2 mx-[-50vw] md:mt-0">
        <div class="max-w-[1280px] px-2.5 sm:px-4 md:px-6 lg:px-8 xl:px-10 mx-auto pt-8 pb-16">
          <h2 className="font-bold text-[32px] sm:text-[36px]">Kontaktinformation</h2>
      ...
      <section className="mt-8 min-[850px]:flex min-[850px]:gap-12 lg:gap-24 md:py-8">
        <div>
          <h2 className="text-[32px] font-bold sm:text-[36px] md:text[46px] mb-8">Consulting</h2>
        ...
        <div className="mt-8 min-[850px]:mt-0">
          <h2 className="text-[32px] font-bold sm:text-[36px] md:text[46px] mb-8">Academy</h2>
          <div className="flex gap-6">
            <div className="min-w-[120px]">
              <Image
                className="bg-ibgreen-400 object-cover aspect-square px-2 bg-gradient-to-t from-darkoverlay via-transparent via-transparent to-transparent"
