    ...
    <>
      ...
      >
        ...
        <Link href="#consultant-areas">
          <Button hasChevron size="xlIcon" className="left-1/2 transform -translate-x-1/2 rounded-full absolute -bottom-7 bg-ibsilver-100 border-2  border-ibsilver-500 hover:bg-ibsilver-100" />
        </Link>
      </section>
      ...
      <SplitSection>
        <SplitSectionChild img className="order-last">
          <Image src="/img/forside-man-with-coffee.jpeg" alt="mand sidder ved bord" width={640} height={750} className="md:w-full md:h-full max-h-[380px] object-cover md:max-h-none bg-ibsilver-400" />
        </SplitSectionChild>
